...
use ruview_unitree_bridge::bridge::publisher::{BridgeRunner, RunnerHandle};
use ruview_unitree_bridge::config::Config;
use ruview_unitree_bridge::protocol::version_guard::{ProtocolPin, ProtocolVersionInfo};
...
async fn main() -> anyhow::Result<()> {
    ...
    ruview_unitree_bridge::protocol::version_guard::emit_protocol_metrics(&protocol);
    ...
    info!(%http_addr, "ruview-unitree-bridge starting");
...
) -> Json<ruview_unitree_bridge::bridge::publisher::HealthSnapshot> {
