...
CHEK_STEREO_MAX_EPIPOLAR_Y_DELTA_PX="${CHEK_STEREO_MAX_EPIPOLAR_Y_DELTA_PX:-36}"
CHEK_STEREO_MIN_DEPTH_M="${CHEK_STEREO_MIN_DEPTH_M:-0.35}"
CHEK_STEREO_MIN_TRIANGULATED_JOINTS="${CHEK_STEREO_MIN_TRIANGULATED_JOINTS:-6}"
